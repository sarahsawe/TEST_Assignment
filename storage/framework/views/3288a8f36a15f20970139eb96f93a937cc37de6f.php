...
.btn{
    ...
    <body class="content">
        ...
        <div class="container-fluid logo">
                <img src="<?php echo e(asset('image/logo.png')); ?>" alt="logo"class="img-fluid" style="width:100px; height:50px;"></img>               
         </div> 
        </section>     
    <div class="row" > 
  ...
  <tbody>
  <?php $__currentLoopData = $data_results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
        <td><?php echo e($data->Project_Ref); ?> </td>  
        <td> <?php echo e($data->Country); ?></td>     
        <td> <?php echo e($data->Implementing_Office); ?></td>     
        <td> <?php echo e($data->Project_Title); ?></td>     
        <td> <?php echo e($data->Grant_amount_USD); ?></td>     
        <td> <?php echo e($data->Dates_from_GCF); ?></td>     
        <td> <?php echo e($data->Start_Date); ?></td>     
        <td> <?php echo e($data->Duration_months); ?></td>     
        <td> <?php echo e($data->End_Date); ?></td>     
        <td> <?php echo e($data->Readiness_or_NAP); ?></td>     
        <td> <?php echo e($data->Type_of_readiness); ?></td>     
        <td> <?php echo e($data->First_disbursement_amount); ?></td>     
...
<?php /**PATH C:\xampp\htdocs\Assignment\resources\views/welcome.blade.php ENDPATH**/ ?>